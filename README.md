...
- 🎨 教材小工場（`Studio.html`）：學習單、作文引導單（含感官觀察四頁組）、作文批改（會考六級分、逐段批改與修改指引）、段考複習講義、閱讀分級改寫（可抓兒童適讀國際時事）、心智圖、家長通知單／海報／LINE 圖文選單（Gemini 生圖）、Google 表單、座位表、敏感資料遮蔽、PDF 工具；選檔支援拍照／貼上，產出可下載 Word／Excel／PDF
